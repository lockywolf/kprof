...
#ifndef PROFILEMODEL_H_
#define PROFILEMODEL_H_
...
class ProfileModel : public QAbstractItemModel {
  ...
  public:
    ...
    virtual bool shortNames() const = 0;
    virtual void setShortNames(bool sh) = 0;
};
